<div class="container">
    ...
    ================================================== -->
		...
		<div class="container marketing">
			...
			<div class="featurette">
				<img class="featurette-image pull-right img-polaroid"
					src="<?php echo base_url(); ?>assets/img/parking_map--test.png">
				<h2 class="featurette-heading">
					Where do I park?!? <span class="muted">Don't worry, we have that
						covered too.</span>
				</h2>
				<p class="lead">We have reserved parking in surrounding parking lots
